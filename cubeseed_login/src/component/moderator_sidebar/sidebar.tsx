    ...
    return(
      ...
      <ul className="sidenav-nav">
          <li className="sidenav-nav-item">
              <Link href={"/moderator/users"} className="sidenav-nav-link">
          ...
          <li className="sidenav-nav-item">
              <Link href={"/moderator/farmer_documents"} className="sidenav-nav-link">
                  <div className='sidenav-link-icon'>
                  <Image 
          src={folderIcon}
          alt="icon"
          ...
          <li className="sidenav-nav-item">
          <Link href={"/moderator/certificates"} className="sidenav-nav-link">
                  <div className='sidenav-link-icon'>
                  <Image 
          src={textIcon}
          alt="icon"
