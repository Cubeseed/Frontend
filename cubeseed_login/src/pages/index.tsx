      ...
      <section>
        ...
        <section className={homeStyles.home}>
          ...
          <ProgressBar index={currentIndex} length={steps} />
            ...
            {step}
            <p className={homeStyles.steps}>{currentIndex + 1} / {steps.length}</p>
            {!isLastStep ? <button type='button' onClick={next} className={homeStyles.actionbutton} >next</button>
              : <button className={homeStyles.actionbutton} >submit</button>}
            <button type='button' onClick={back} className={homeStyles.actionbutton} >back</button>
          </form>
          <Carousel />
        </section>
        <div className={homeStyles.member}>
          <p>
            Already a member? <Link className={homeStyles.memberlink} href="/">Log In</Link>
          </p>
        </div>
      </section>
    </>
