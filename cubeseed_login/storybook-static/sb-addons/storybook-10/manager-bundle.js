try {
  ...
  var Rt = __STORYBOOKCLIENTLOGGER__,
    {
      deprecate: Et,
      logger: Y,
      once: Mt,
  ...
  function H(e) {
    ...
    return (
      (H = function (r) {
        ...
        function a() {
          return C(r, arguments, A(this).constructor)
        }
        return (
...
`,
  ...
  var u = (function (e) {
    ...
    function t(r) {
      for (
        ...
        o[i - 1] = arguments[i]
      return (
        (a = e.call(this, se.apply(void 0, [ie[r]].concat(o))) || this), re(a)
      )
    }
    return t
  })(H(Error))
  ...
  function T(e) {
    ...
    var o = be.exec(t.substring(0, 50))
    if (o)
      return {
        red: parseInt("" + o[1], 10),
    ...
    var f = me.exec(t.substring(0, 50))
    if (f) {
      var _ = parseInt("" + f[1], 10),
        ee = parseInt("" + f[2], 10) / 100,
        te = parseInt("" + f[3], 10) / 100,
        N = "rgb(" + F(_, ee, te) + ")",
        S = R.exec(N)
      if (!S) throw new u(4, t, N)
      return {
        red: parseInt("" + S[1], 10),
  ...
  function $(e, t, r) {
    if (typeof e == "number" && typeof t == "number" && typeof r == "number")
      return D("#" + m(e) + m(t) + m(r))
    if (typeof e == "object" && t === void 0 && r === void 0)
      return D("#" + m(e.red) + m(e.green) + m(e.blue))
    throw new u(6)
  }
  function w(e, t, r, a) {
  ...
  function Be(e, t) {
    ...
    var r = T(t),
      ...
      n = v({}, r, { alpha: j(0, 1, (a * 100 + parseFloat(e) * 100) / 100) })
    return w(n)
  }
  var Gt = I(Be)
  function Re(e, t) {
    ...
    var r = T(t),
      a = typeof r.alpha == "number" ? r.alpha : 1,
      n = v({}, r, {
        alpha: j(0, 1, +(a * 100 - parseFloat(e) * 100).toFixed(2) / 100),
      })
    return w(n)
  }
  var Ee = I(Re),
  ...
  var V = q({
    base: "light",
    brandTitle: "Cubeseed",
    brandUrl: "https://cubeseed.com.ng",
    brandImage:
      "https://cubeseed.com.ng/wp-content/uploads/2023/06/image-127x28.png",
    brandTarget: "_self",
  })
  G.setConfig({ theme: V })
} catch (e) {
