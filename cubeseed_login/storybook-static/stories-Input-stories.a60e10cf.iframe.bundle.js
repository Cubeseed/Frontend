                  ...
                  (0, esm_extends.Z)(
                    {
                      ...
                      placeholder: "",
                      className:
                        "peer h-full w-full rounded-[4px] border border-[#99A19F] border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-primary outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-[#99A19F] focus:border-2 focus:border-primary-100 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-[#99A19F]",
                    },
                    props
                  )
                ),
        ...
        try {
          ;(Input.displayName = "Input"),
            ...
            "undefined" != typeof STORYBOOK_REACT_CLASSES &&
              (STORYBOOK_REACT_CLASSES["stories/Input.tsx#Input"] = {
                docgenInfo: Input.__docgenInfo,
                name: "Input",
                path: "stories/Input.tsx#Input",
              })
